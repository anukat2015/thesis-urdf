...
/**
 */
public class UDragClickControl extends Control
{
	 ...
	 */
	public function UDragClickControl(filter:*=null, numClicks:uint=1,drag:Boolean = true,
	...
	private function onClick(event:MouseEvent):void
	{
	    ...
	    // new by Timm Meiser on 22.10.2010
		if(_cur is DataSprite && (_cur as DataSprite).fixed) 
	...
	private function onUp(event:MouseEvent) : void {
		if (_cur != null && _cur.stage != null) {
			if(_cur.stage.hasEventListener(MouseEvent.MOUSE_UP))
	...
	private function onTimer(event:Event=null):void
	{
		...
		if(_cur != null && _cur.stage != null) {
		    //trace("I release the drag listener!");
		    _cur.stage.removeEventListener(MouseEvent.MOUSE_MOVE, onDrag);
		}
	}
	
} // end of class UDragClickControl
