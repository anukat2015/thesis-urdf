package uviface.viz.util
{
	...
	public class USort
	{
		...
		public static function sortOn(field:String):Function
		{
			...
			return function(a:Object, b:Object):int {
				if(a is NodeSprite && b is NodeSprite) {
					var node1:NodeSprite = a as NodeSprite;
					var node2:NodeSprite = b as NodeSprite;
					var property1:* = (node1.data.hasOwnProperty(field)) ? node1.data.field : null;
					var property2:* = (node2.data.hasOwnProperty(field)) ? node2.data.field : null;
					return (asc?1:-1)*(property1 > property2 ? 1 : property1 < property2 ? -1 : 0);
				} 
				else 
				  return c=1.0;
				//var da:* = p.getValue(a);
		...
		public static function sortOnLabel(ascending:Boolean):Function
		{
			//var p:Property = Property.$(field);
			return function(a:Object, b:Object):int {
				if(a is NodeSprite && b is NodeSprite) {
					var node1:NodeSprite = a as NodeSprite;
					var node2:NodeSprite = b as NodeSprite;
					var property1:* = (node1.data.hasOwnProperty("label")) ? node1.data.label : null;
					var property2:* = (node2.data.hasOwnProperty("label")) ? node2.data.label : null;
					//trace("node 1 is : " + node1.data.label);
					//trace("node 2 is : " + node2.data.label);
					//trace("result : " + ((ascending?1:-1)*(property1 > property2 ? 1 : property1 < property2 ? -1 : 0)));
					return (ascending?1:-1)*(property1 > property2 ? 1 : property1 < property2 ? -1 : 0);
				} 
				else {
				  //trace("Shit");
				  return 1;
