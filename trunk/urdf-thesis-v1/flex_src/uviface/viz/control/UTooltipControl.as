package uviface.viz.control
{
	 ...
	 */
	public class UTooltipControl extends Control
	{		
		 ...
		 */
		public function UTooltipControl(filter:*=null,
		...
		private function onShow(evt:TimerEvent=null):void
		{
            ...
            // ------------------------------------------------
            // added on 12.12.10
            if(_object == null || _cur == null || !((_cur is NodeSprite) || (_cur is EdgeSprite)))
               return;
            // ------------------------------------------------
