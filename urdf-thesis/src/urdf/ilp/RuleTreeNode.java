	...
	public Rule getBestFinalParentRule() {
		...
		if (this.parent==null)
			...
			while (currentNode.parent!=null) {
				...
				System.out.println(bestConf+"<"+currentRule.getConfidence() + " currentRule="+currentRule.getRuleString());
				if (bestConf < currentRule.getConfidence() && currentRule.bindsHeadVariables()) {
